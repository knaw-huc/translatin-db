...
SELECT
    ...
    M1.ORIGIN ORIGIN1,
    COALESCE(M1.FORM::varchar, '?') FORM1,
	COALESCE(M1.GENRE::varchar, '?') GENRE1,
	COALESCE(M1.SUBGENRE::varchar, '?') SUBGENRE1,
    ...
    M2.ORIGIN ORIGIN2,
    COALESCE(M2.FORM::varchar, '?') FORM2,
	COALESCE(M2.GENRE::varchar, '?') GENRE2,
	COALESCE(M2.SUBGENRE::varchar, '?') SUBGENRE2,
